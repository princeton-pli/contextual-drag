...
declare -A STEPS_MAP=( ["1"]="revise1" ["2"]="revise2" ["3"]="solve" )
STEP=${STEPS_MAP[$1]}
NUM_PARTITIONS=1
...
for MODEL in "${MODELS[@]}"; do
    ...
    for TASK in "${TASKS[@]}"; do
        ...
        EVAL_DIR="context_denoising/revise2/${STEP}/${TASK}/${MODEL}"

        case "$STEP" in
            solve)
                DATA_PATH="context_denoising/revise2/revise2/${TASK}/${MODEL}/processed_flattened_init_responses.ds"
                case "$TASK" in
                ...
                ;;
            revise2)
                DATA_PATH="context_denoising/revise2/revise1/${TASK}/${MODEL}/processed_flattened_init_responses.ds"
                case "$TASK" in
                    crux-i)  TEMPLATE_KEY="revise_revise2_${STEP}_crux_input" ;;
                    gpqa|mmlu) TEMPLATE_KEY="revise_revise2_${STEP}_qa_mc" ;;
                    *)       TEMPLATE_KEY="revise_revise2_${STEP}" ;;
                esac
        ...
        JOB_NAME="${TASK}-revise2-${STEP}-N${N_SAMPLES}-${MODEL}"
