...
python3 ../utils/general_inference/vllm_serving.py \
    ...
    --num_partitions 1 \
    --output_dir ./outputs/SR_Training/GPT_OSS_20B/init_sampling \
    --n 4 \
    --batch_size 16384 \
...
python3 ../utils/verifiable_evaluation/math_eval/eval.py -f -s -d ./outputs/SR_Training/GPT_OSS_20B/init_sampling -j 48
