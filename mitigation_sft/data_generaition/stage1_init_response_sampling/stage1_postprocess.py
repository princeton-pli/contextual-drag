...
def main():
    ...
    final_eval_model_list = ['GPT_OSS_20B', 'Qwen3_8B', 'Nemotron_7B', 'LlamaR1_8B', 'QwenR1_7B']
    ...
    parser.add_argument("--model_list", "-l", nargs='+', type=str, default=final_eval_model_list, help="List of models to process")
    parser.add_argument("--output_file", "-o", type=str, default="training_mix.ds", help="Output file name")
