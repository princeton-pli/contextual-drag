...
This script provides batch inference capabilities with model configuration management,
SLURM array job support, and resume functionality. It uses modular components for
...
Usage examples:
    ...
    python vllm_serving.py --model_config "LlamaR1_8B"
    
    # List available configurations
    python vllm_serving.py --list_models
    
    # Use with parameter overrides
    python vllm_serving.py --model_config "Qwen3_8B_NoThinking" --temperature 0.8
"""
...
from src.data_utils import load_data, partition_dataset, prepare_prompts_from_dataset
...
from src.slurm_utils import get_partition_id, print_job_info
